...
const Projects = () => {
    ...
    return (
        <motion.div
            ...
            viewport={{ once: true }}
            className='container mx-auto py-4 pt-20 px-6 md:px-20 lg:px-32 my-20 w-full overflow-y-hidden' id='Projects'>
            ...
            <p className='text-center text-gray-500 mb-8 max-w-80 mx-auto'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Iure, delectus?</p>
