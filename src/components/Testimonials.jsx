...
const Testimonials = () => {
    return (
        <motion.div
            ...
            <p className='text-center text-gray-500 mb-8 max-w-80 mx-auto'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Expedita, aperiam!</p>

            {/* Customer Testimonials or Review  */}
