...
const Contact = () => {
    ...
    const onSubmit = async (event) => {
        ...
        formData.append("access_key", "846fcf7f-9897-4c37-b80d-16bf97cd7680");
    ...
    return (
        <motion.div
            ...
            <form onSubmit={onSubmit} className='max-w-2xl mx-auto pt-8'>
                ...
                <button className='bg-blue-600 text-white py-2 px-12 mb-10 rounded-3xl'>{result ? result : "Send Message"}</button>
            </form>
